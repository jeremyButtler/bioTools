...
" decerments 2 digit functions nubmers by amount
function! DecrimentTwoDigFun(start, end, amount)
   let l:funNum = a:start
   let l:cursorPos = winsaveview()
      " save cursor to position

   while l:funNum <= a:end
      let l:nextNum = l:funNum - a:amount
...
" decerments 3 digit functions nubmers by amount
function! DecrimentThreeDigFun(start, end, amount)
   let l:funNum = a:start
   let l:cursorPos = winsaveview()
      " save cursor to position
